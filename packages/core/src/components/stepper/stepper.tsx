...
import { IAttachedStep, IStepProps } from "./step";
...
type StepChild = Array<React.ReactElement<IStepProps>> | React.ReactElement<IStepProps>;

@polyfill
export class Stepper extends React.PureComponent<
    IStepperProps & React.HTMLAttributes<HTMLDivElement> & { children: StepChild }
> {
    public render() {
        const {
            children,
    ...
    private renderContent = (): React.ReactNode => {
        ...
        return steps.map((step: React.ReactElement<IStepProps>, index: number) => {
            const state: Partial<IStepProps & IAttachedStep> = {
                active: false,
                completed: false,
                disabled: false,
                large,
            ...
            return [
                ...
                React.cloneElement<IStepProps & IAttachedStep>(step, {
                    ...state,
